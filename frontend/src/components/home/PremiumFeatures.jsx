...
import { FaCheckCircle, FaArrowRight, FaDesktop, FaMobileAlt, FaSearch, FaCalendarAlt } from 'react-icons/fa';
              ...
              <div className="flex-1 w-full flex flex-col justify-center">
                {feature.logos ? (
                  <div className="flex items-center gap-6 mb-8">
                    <img src={feature.logos[0]} alt="TecRMI" className="h-10 object-contain" />
                    <div className="w-px h-10 bg-slate-300"></div>
                    <img src={feature.logos[1]} alt="Solera Autodata" className="h-8 object-contain" />
                  </div>
                ) : (
                  ...
                  <ul className="space-y-5 mb-10">
                    {feature.points.map((point, i) => (
                      <li key={i} className="flex gap-4">
                        ...
                        <span className="text-slate-600 leading-relaxed text-[15px]">{point}</span>
                      </li>
                    ))}
                  </ul>
                ) : (
